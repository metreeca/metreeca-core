...
public final class _LinkException extends RuntimeException {
	...
	public _LinkException(final int status) {
		this(status, "", null);
	}

	public _LinkException(final int status, final String report) {
		this(status, report, null);
	}

	public _LinkException(final int status, final String report, final Throwable cause) {

 ...
 * HTTP response.
 */
public final class _Response extends _Message<_Response> {
	...
	@Override protected _Response self() { return this; }
	...
	public _Response setStatus(final int status) { // !!! § valid HTTP response status // https://tools.ietf.org/html/rfc7231#section-6
	...
	public _Response setCause(final Throwable cause) {
	...
	public _Response setBody(final Consumer<OutputStream> body) { // !!! § supports streaming / once > IllegalStateException
	...
	public _Response mapBody(final UnaryOperator<Consumer<OutputStream>> mapper) { // !!! § supports self-references
	...
	public _Response setData(final byte... data) {

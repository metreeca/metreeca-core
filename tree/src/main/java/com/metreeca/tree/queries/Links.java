...
public final class Links implements Query {
	...
	public static Links links(final Shape shape, final String... path) {
		return new Links(shape, asList(path));
	}

	public static Links links(final Shape shape, final List<String> path) {
		return new Links(shape, path);
	}
	...
	private Links(final Shape shape, final List<String> path) {
	...
	@Override public boolean equals(final Object object) {
		return this == object || object instanceof Links
				&& shape.equals(((Links)object).shape)
				&& path.equals(((Links)object).path);
	}

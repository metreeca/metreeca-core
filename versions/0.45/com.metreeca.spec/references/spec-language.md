...
| shape                                    | constraint                               |
| :--------------------------------------- | :--------------------------------------- |
| [datatype](../javadocs/com/metreeca/spec/shapes/Datatype.html)([IRI](http://docs.rdf4j.org/javadoc/latest/org/eclipse/rdf4j/model/IRI.html)) | each term in the focus set has a given extended RDF datatype IRI |
...
| [range](../javadocs/com/metreeca/spec/shapes/Range.html)([value](http://docs.rdf4j.org/javadoc/latest/org/eclipse/rdf4j/model/Value.html), …) | each term in the focus set is a member of a given set of range values |
...
<!-- document extended datatype constraints for IRIs/BNodes -->
...
| :--------------------------------------- | :--------------------------------------- |
| [required](../javadocs/com/metreeca/spec/Shape.html#required—) | `and(minCount(1), maxCount(1))`          |
| [optional](../javadocs/com/metreeca/spec/Shape.html#optional—) | `maxCount(1)`                            |
| [repeatable](../javadocs/com/metreeca/spec/Shape.html#repeatable—) | `minCount(1)`                            |
| [multiple](../javadocs/com/metreeca/spec/Shape.html#multiple—) | `and()` / always meet                    |
| [values](../javadocs/com/metreeca/spec/Shape.html#values-org.eclipse.rdf4j.model.Value...-)([value](http://docs.rdf4j.org/javadoc/latest/org/eclipse/rdf4j/model/Value.html), …) | `and(all(value, …), range(value, …))` / constant pre-defined values |
...
| [client](../javadocs/com/metreeca/spec/Spec.html#client) | [client](../javadocs/com/metreeca/spec/Shape.html#client-com.metreeca.spec.Shape...-)([shape](../javadocs/com/metreeca/spec/Shape.html), …) | POST+GET+DELETE / shorthand for client-managed data, specified at creation time, but not updated afterwards |

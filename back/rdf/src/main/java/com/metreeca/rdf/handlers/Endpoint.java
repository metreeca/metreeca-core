...
public abstract class Endpoint<T extends Endpoint<T>> extends Delegator {
	...
	private Set<IRI> query=singleton(Form.root); // roles enabled for query operations
	private Set<IRI> update=singleton(Form.root); // roles enabled for update operations

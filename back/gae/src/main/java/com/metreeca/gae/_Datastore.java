...
public final class _Datastore {

	private static final int Version=0; // store layout version

	private static final String StoreKind=_Datastore.class.getName()+":store";
	private static final String GraphKind=_Datastore.class.getName()+":graph";
	private static final String SpaceKind=_Datastore.class.getName()+":space";
	private static final String EntryKind=_Datastore.class.getName()+":entry";

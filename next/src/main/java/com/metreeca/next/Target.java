 ...
 * Content target.
 *
 * <p>Provides on-demand textual/binary access to a content target.</p>
 *
 * <p>Must override at least one of the {@link #writer()} ()}/{@link #output()} ()} methods.</p>
 */
public interface Target {
	 ...
	 */
	public default Writer writer() { return Transputs.writer(output()); }
	 ...
	 */
	public default OutputStream output() { return Transputs.output(writer()); }

...
public abstract class Message<T extends Message<T>> {
	 ...
	 * representation generated by filtering it with mapping function; if this message has no body representation
	 * associated to the given format, filtering has no effect.</p>
	 *

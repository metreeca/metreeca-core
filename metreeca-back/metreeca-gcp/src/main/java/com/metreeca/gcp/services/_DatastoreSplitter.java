...
final class _DatastoreSplitter {
	...
	private static final class ContainerProbe extends SplitterProbe {
		...
		@Override public Shape probe(final Field field) {
			return field.getName().equals(GCP.contains) ? traversed(and()) : field;
		}
	...
	private static final class ResourceProbe extends SplitterProbe {
		...
		@Override public Shape probe(final Field field) {
			return field.getName().equals(GCP.contains) ? traversed(field.getShape()) : and();
		}

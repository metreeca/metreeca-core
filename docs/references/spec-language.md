...
| shape                                    | constraint                               |
| :--------------------------------------- | :--------------------------------------- |
| [trait](../javadocs/com/metreeca/form/shapes/Trait.html)([shift](../javadocs/com/metreeca/form/Shift.html), [shape](../javadocs/com/metreeca/form/Shape.html)) | the derived focus set generated by a path  *shift* is consistent with a given shape |

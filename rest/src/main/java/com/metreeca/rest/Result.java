 ...
 * report a failure.</p>
 *
 * @param <V> the type of the result value expected from the operation
 */
public interface Result<V> {

	/**
	 * Creates a returned value operation result.
	 *
	 ...
	 *
	 * @return a result providing access to ve value generated by applying {@code mapper} to the returned value of this

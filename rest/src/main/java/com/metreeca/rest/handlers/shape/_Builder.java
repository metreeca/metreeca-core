...
public final class _Builder {

	//public static _Builder builder(final Shape shape, final String sparql) {
	//
	//	if ( shape == null ) {
	...
	//}
	//
	//public static _Builder builder(final Shape shape, final Function<Request, Collection<Statement>> builder) {
	//
	//	if ( shape == null ) {
	//		throw new NullPointerException("null shape");
	//	}
	...
	//	}
	//
	//	return new _Builder(shape, builder);
	//}
	//
	//
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//
	//
	//private _Builder(final Shape shape, final Function<Request, Collection<Statement>> builder) {
	//
	//	this.shape=shape

 ...
 *
 * <p>The response {@linkplain RDFFormat RDF body} includes the description of the request target as generated by the
...
public final class Generator extends Delegator {
	 ...
	 *
	 * @param generator a function mapping from a request and its {@linkplain RDFFormat RDF} payload to a possibly empty

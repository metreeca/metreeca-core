 ...
 * Request#item() focus item}, as generated by the {@linkplain #model(Function) virtual model generator} and redacted
 * according to the linked data {@linkplain Shape shape} associated with the request, if one is present .</dd>
 *

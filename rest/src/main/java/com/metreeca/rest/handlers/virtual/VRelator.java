 ...
 *
 * <dd>If no shape is provided, the response {@link RDFFormat} body contains the RDF description of the request focus
 * generated by the {@linkplain #model(Function) virtual model generator}.</dd>
 *
 ...
 *
 * <dd>The response {@link RDFFormat} body contains the subset of RDF description of the request focus generated by the
 * {@linkplain #model(Function) virtual model generator} matched by the redacted shape.</dd>
 *
 * </dl>
 *

 ...
 * item}.</p>
 *
 * <p>If the request target is not a {@linkplain Request#container() container}:</p>
 *
 * <ul>
 *
 ...
 * </ul>
 *
 * <p>If the request includes a {@linkplain Message#shape() resource shape}:</p>
 *
 * <ul>
 *
...
public final class Creator extends Actor {
	 ...
	 *             resources are reported with a {@linkplain Response#Conflict} status code and a structured
	 *             {@linkplain Failure#trace(JsonValue) trace} element
	 *

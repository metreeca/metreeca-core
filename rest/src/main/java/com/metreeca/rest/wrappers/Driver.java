 ...
 * {@linkplain Request#roles() roles} of the current request {@linkplain Request#user() user}; target tasks associated
 * with an empty task and user-specific shape are omitted from the description.</li>
 *
 * </ul>
 *

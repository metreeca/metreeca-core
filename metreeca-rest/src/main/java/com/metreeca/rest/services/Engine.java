...
public interface Engine {
     ...
     * {@linkplain Message#shape() shape}; an error providing access to a failure possibly
     * {@linkplain Failure#trace(Trace) containing} a validation trace, otherwise
     *
     ...
     * access to a failure possibly {@linkplain Failure#trace(Trace) containing} a validation trace, otherwise
     *
     * @throws NullPointerException if {@code message} is null
     */

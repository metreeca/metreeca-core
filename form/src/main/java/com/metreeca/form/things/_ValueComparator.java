...
/**
 * !!! copied from query algebra evaluation mmodule to avoid dependencies on repositry API !!!
 *
 ...
 */
final class _ValueComparator implements Comparator<Value> {
	 ...
	 * _ValueComparator#compareLiterals(Literal, Literal, CompareOp)} is used in consecutive ordering steps.
	 */
